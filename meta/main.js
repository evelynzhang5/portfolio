...
function renderScatterPlot(data, inputCommits) {
  ...
  svg.append('g')
    ...
    // .attr('fill', d => d.hourFrac < 6 || d.hourFrac >= 20 ? '#4f46e5' : '#f59e0b')
    .attr('class', d =>
        'dot ' + (d.hourFrac < 6 || d.hourFrac >= 20 ? 'night' : 'day')
      )      
...
renderScatterPlot(data, processedCommits);
